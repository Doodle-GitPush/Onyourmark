...
export function Logo3DViewer({ svgContent, color, material, autoRotate }: Logo3DViewerProps) {
    ...
    return (
        <div className="w-full h-[560px] rounded-[20px] overflow-hidden bg-gradient-to-b from-slate-100 to-slate-200 relative">
            <Canvas
                shadows
                dpr={[1, 2]}
            ...
            >
                ...
                <Environment resolution={256}>
                    <group rotation={[-Math.PI / 3, 0, 1]}>
                        <Lightformer form="circle" intensity={4} rotation-x={Math.PI / 2} position={[0, 5, -9]} scale={3} />
                        <Lightformer form="circle" intensity={2} rotation-y={Math.PI / 2} position={[-8, 1, -1]} scale={3} />
                        <Lightformer form="circle" intensity={2} rotation-y={-Math.PI / 2} position={[10, 1, 0]} scale={5} />
                        <Lightformer form="ring" color="#a78bfa" intensity={2} scale={6} position={[0, 6, -1]} />
                    </group>
                </Environment>

                <ContactShadows position={[0, -14, 0]} opacity={0.35} scale={60} blur={2.5} far={20} />
